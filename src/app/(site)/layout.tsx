 ...
 *
 * The pixel trail is mounted here rather than in the root layout for the same
 * reason: this group is every page that is not the room, so the room keeps its
 * plain pointer without needing to opt out.
 */
